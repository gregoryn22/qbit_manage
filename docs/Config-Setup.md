...
| `share_limits_pending_cleanup_tag`  | Will add this tag when applying share limits to torrents that match a cleanup-eligible group but have not yet reached max_seeding_time (Used in `--share-limits`)                                                                                                                                                                               | PendingCleanup            | <center>❌</center> |
